...
import LoadingSpinner from '../assets/components/LoadingSpinner'; // Import the spinner component
...
export default function MealDetails() {
  ...
  // Function to fetch meal details with a delay
  ...
  // Fetch meal details when idMeal changes
  useEffect(() => {
    if (idMeal) {
